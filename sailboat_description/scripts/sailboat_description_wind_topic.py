...
direction_pub = rospy.Publisher('/sailboat_description_wind_topic/direction', Float64, queue_size=10)
direction_msg = Float64()
direction_msg.data = -90.0
#Create the publisher to the wind speed topic.
speed_pub = rospy.Publisher('/sailboat_description_wind_topic/speed', Float64, queue_size=10)
speed_msg = Float64()
speed_msg.data = 20.0
